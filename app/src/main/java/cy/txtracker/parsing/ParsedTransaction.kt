...
/**
 * The output of a [NotificationParser]. The listener then computes `merchantNormalized`,
 * `timeBucket`, and `notificationDedupeKey` from these values before inserting into the DB.
 */
